...
## Match images with (synthetic) captions

The pixparse samples come with a single textual description per image. There are multiple synthetic captions for CC3M, CC12M, and YFCC15M generated by MLLLMs that can be downloaded from huggingface.
