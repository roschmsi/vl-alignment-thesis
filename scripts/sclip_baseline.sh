...
output_name="a_dinov2_nv2_cc3m_nsup=10k_nunsup_100k_sclip_unimodal_pl=soft_unpaired_wimg=0.01_wtext=0_ep=300"
...
python /home/eml/simon.roschmann/ot-alignment/main.py \
    ...
    --sclip_pseudo_label_type soft \
    --sclip_weight_unpaired_images 0.01 \
